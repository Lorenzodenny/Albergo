...
namespace Albergo.Models
{
    public class Ospite
    {
        ...
        [StringLength(50, MinimumLength = 2, ErrorMessage = "il Nome deve contenere meno di 50 caratteri, almeno 2")]
        public string Nome { get; set; }

        // Cognome
        [Required(ErrorMessage = "Campo Obbligatorio")]
        [StringLength(50, MinimumLength = 2, ErrorMessage = "il Cognome deve contenere meno di 50 caratteri, almeno 2")]
        public string Cognome { get; set; }

        // Citta
        [Required(ErrorMessage = "Campo Obbligatorio")]
        [StringLength(50, MinimumLength = 2, ErrorMessage = "la CIttà deve contenere meno di 50 caratteri, almeno 2")]
        public string Citta { get; set; }

        // Provincia
        [Required(ErrorMessage = "Campo Obbligatorio")]
        [StringLength(50, MinimumLength = 2, ErrorMessage = "la Provincia deve contenere meno di 50 caratteri, almeno 2")]
